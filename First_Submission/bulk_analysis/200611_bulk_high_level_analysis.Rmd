...
sars_time_cor = ggplot(covid_counts_binarized, aes(x = day_of_intubation, y = all_viral_counts)) +
  geom_point() +
  scale_y_continuous(trans = "log10") +
  xlab("Day of Mechanical Ventilation") +
  ylab("SARS-CoV-2 Counts") +
  geom_smooth(se = F, color = fig2_pal[2]) +
  theme_bw(base_family = "Arial", base_size = 32) +
  theme(text = element_text(family = "Arial")) +
  annotate(x = 30, y = 5e4, label = paste("ρ = ", time_cor_rho), size = 10, geom = "text")
sars_time_cor
```
...
### Average expression   
```{r}
m14_cor = cor.test(covid_umap$AEpurple, covid_umap$finite_day_of_intubation)
module_14_corplot = ggplot(covid_umap, aes(x = finite_day_of_intubation, y = AEpurple)) +
  geom_point() +
  annotate(geom = "text", x = 30, y = 2, label = paste0("R = ", round(m14_cor$estimate, digits = 2)), size = 6) +
  geom_smooth(method = "lm", color = fig2_pal[2]) +
  theme_bw() +
  xlab("Day of Mechanical Ventilation") +
  ylab("Average Module 14 Expression") +
  theme(legend.position = "none", 
        text = element_text(size = 32, family = "Arial"),
        plot.title = element_text(hjust = 0.5))
module_14_corplot
...
typei_corplot = ggplot(covid_umap, aes(x = finite_day_of_intubation, y = typeI_IFN_response)) +
  geom_point() + 
  geom_smooth(method = "lm", color = fig2_pal[2]) +
  annotate(geom = "text", x = 30, y = 1750, label = paste0("R = ", round(typei_cor$estimate, digits = 2)), size = 6) +
  theme_bw() +
  theme(legend.position = "none", 
        text = element_text(size = 32, family = "Arial"),
        plot.title = element_text(hjust = 0.5)) +
  ylab("Average Type I IFN Pathway Gene Expression") +
  xlab("Day of Mechanical Ventilation")
typei_corplot 
...
typeii_corplot = ggplot(covid_umap, aes(x = finite_day_of_intubation, y = IFNg_response)) +
  geom_point() + 
  geom_smooth(method = "lm", color = fig2_pal[2]) +
  annotate(geom = "text", x = 30, y = 3000, label = paste0("R = ", round(typeii_cor$estimate, digits = 2)), size = 6) +
  theme_bw() +
  theme(legend.position = "none", 
        text = element_text(size = 32, family = "Arial"),
        plot.title = element_text(hjust = 0.5)) +
  ylab("Average IFNg Pathway Gene Expression") +
  xlab("Day of Mechanical Ventilation")
typeii_corplot
...
### Figure 3   
```{r}
dea_hits = readRDS("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/GEO_output/200728_bulk_dea_complete.rds")
cov2_kmeans_clustered = readRDS("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/200721_k_means_clustered.rds")
...
layout = "AABB\nAACC\nDEFG"
bulk_plot_fig3 = fig3_heatmap_gg +
  viral_expression_heatmap_gg +
  ...
  typeii_corplot +
    ...
    plot_annotation(tag_levels = 'a', 
                  theme = theme(text = element_text(size = 120, family = "Arial"),
...
fig3_genes = c("IL6", "CCL24", "CCL8", "CCL2", "CCL7", 
               "RNASE1", "CCR1", "MAFB", "CSF2RA", "BAG3", 
               "HIF1", "LAMP3", "CCL20", "IL1A", "IL1B",
               "CD164", "MFGE8", "FCGR2A", "IL13RA1", "FABP4",
