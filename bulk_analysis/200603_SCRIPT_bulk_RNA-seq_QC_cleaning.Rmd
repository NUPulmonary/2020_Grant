...
## Flow data   
```{r}
flow_data = readRDS("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/2020-07-24_SCRIPT_flow_plus_clinical_metadata_processed.rds") %>% 
...
clinical_md = readRDS("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/2020-07-24_SCRIPT_clinical_metadata_processed.rds")
md = left_join(md, 
               clinical_md, 
               by = c("tc_pt_study_id"), 
               na_matches = "never")
...
```{r}
saveRDS(script_bulk, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/200721_script_bulk_des.rds")
saveRDS(script_bulk_samples, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/200721_script_bulk_des_no_hURNA.rds")
```
