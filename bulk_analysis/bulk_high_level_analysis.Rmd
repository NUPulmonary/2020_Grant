...
## Import data   
```{r}
mp = readRDS("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_script_bulk_des_no_hURNA.rds")
...
cov2_kmeans_clustered$expression = counts(mp_des, normalized = T) %>% 
  ...
  right_join(gene_conv, .)
saveRDS(cov2_kmeans_clustered, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_clustered.rds")
saveRDS(cov2_kmeans_noclustering, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_unclustered.rds")
write.csv(cov2_kmeans_clustered$genes, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_genes.csv")
write.csv(cov2_kmeans_clustered$go_df, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_GO.csv")
```   
...
kmeans_d0$expression = counts(mp_des, normalized = T) %>% 
  ...
  right_join(gene_conv, .)
saveRDS(kmeans_d0, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_d0.rds")
write.csv(kmeans_d0$genes, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_d0_genes.csv")
write.csv(kmeans_d0$go_df, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_d0_GO.csv")
```   
...
```   
7 looks like the intersection after adding healthy controls, removing bad samples. Still true as of 2020-11-30.   
...
```{r}
module_names = data.frame(color = gsub("ME", "", colnames(MEs)),
                          module_name = paste0("Module ", 1:ncol(MEs)))
module_assignments = data.frame(ensembl_gene_id = colnames(all_counts),
                                color = factor(mergedColors)) %>% 
  left_join(., gene_conv) %>% 
...
cd206_correlated = subset(module_assignments, color =="brown")
cd206_anticorrelated = subset(module_assignments, color =="turquoise")
cd206_correlated
...
```{r}
covid_correlated_cd206_uncorrelated = subset(module_assignments, color =="tan")
...
saveRDS(covid_umap, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_covid_umap.rds")
...
write.csv(final_counts_raw, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/GEO_output/201130_raw_counts_geo.csv")
write.csv(final_md_safe, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/GEO_output/201130_deidentified_metadata_geo.csv")
```
...
saveRDS(dea_hits, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/GEO_output/201130_bulk_dea_complete.rds")
```
...
all_sheets = c(list("k-means genes" = output_genes,
                    ...
                    "WGCNA module assignments" = module_assignments),
               dea_hits)
write.xlsx(x = all_sheets,
           file = "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_bulk_supplmental_data.xlsx")
```
...
dea_hits = readRDS("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/GEO_output/201130_bulk_dea_complete.rds")
d0_hm_gg = readRDS("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_d0.rds")$plot %>% 
  as.ggplot()
...
CairoPDF("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_fig3_rough.pdf",
...
### Figure S3   
```{r}
cov2_kmeans_noclustering = readRDS("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_unclustered.rds")
...
CairoPDF("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_figS3_bottom_quest.pdf",
...
### Export metadata for internal use   
```{r}
...
csv_safe_md = md %>% 
  ...
  as.data.frame()
write.csv(csv_safe_md, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_bulk_mp_metadata.csv")
```
...
safe_md = read.csv("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/GEO_output/201130_deidentified_metadata_geo.csv") %>% 
   dplyr::select(sample, anonymized_patient_id = patient_id)
...
saveRDS(progression_hm, "/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_patient_progression_heatmap.rds")
```
...
goi = c(subset(module_assignments, color =="tan" & ensembl_gene_id %in% hits)$gene_name, cov2_genes$gene_name) %>% 
  unique()
...
goi = c(subset(module_assignments, color =="tan" & ensembl_gene_id %in% hits)$gene_name, non_human_genes$gene_name) %>% 
  unique()
...
```{r}
cov2_kmeans_clustered_gg = readRDS("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_k_means_clustered.rds")$plot %>% 
  as.ggplot()
...
CairoPDF("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_fig4_rough_quest.pdf",
    width = max_width_nature * 2,
    height = max_height_nature * 2, family = "Arial")
fig4
dev.off()
...
fig4_bottom = (typei_corplot + ylab("")) +
  (typeii_corplot + ylab("Average Expression")) +
  (module_15_corplot + ylab("") + xlab("Days from First Intubation")) +
  progression_hm_ggplot +
    plot_layout(design = layout) +
    plot_annotation(tag_levels = 'a') & theme(plot.tag = element_text(size = 20, family = "Arial"))
CairoPDF("/projects/b1038/Pulmonary/rgrant/script_bulk/Analysis/201130_fig4_bottom_quest.pdf",
