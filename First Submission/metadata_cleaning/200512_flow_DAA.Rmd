...
timeline_data_covid = timeline_data_covid %>% 
  unique() %>% 
  dplyr::filter(!(study_id == 1240 & event == "death" & date == as.Date("XXXXXXXXXX"))) %>% 
  dplyr::filter(!(study_id == 1292 & event == "death" & date == as.Date("XXXXXXXXXX"))) %>% 
  dplyr::filter(!(study_id == 1296 & event == "death" & date == as.Date("XXXXXXXXXX"))) %>% 
